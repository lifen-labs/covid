...
RSpec.describe UpdatePatientForm, type: :model do
  ...
  let(:is_healthcare_professional)                      { other_patient.is_healthcare_professional.to_s }
  let(:pregnant)                                        { other_patient.pregnant.to_s }
  let(:pregnant_since_in_weeks)                         { other_patient.pregnant_since_in_weeks }
  let(:home_caregivers)                                 { other_patient.home_caregivers.to_s }
  ...
  let(:interstitial_alveolus_infiltrates)               { other_patient.interstitial_alveolus_infiltrates.to_s }
  let(:notable_long_term_treatments)                    { other_patient.notable_long_term_treatments }
  let(:sars_cov_2_treatment)                            { other_patient.sars_cov_2_treatment.to_s }
  let(:sars_cov_2_treatment_name)                       { other_patient.sars_cov_2_treatment_name }
  let(:home_follow_up_elligible)                        { other_patient.home_follow_up_elligible.to_s }

  let(:comorbidity_chronic_cardiac_disease)             { other_patient.comorbidity_chronic_cardiac_disease.to_s }
  let(:comorbidity_chronic_pulmonary_disease)           { other_patient.comorbidity_chronic_pulmonary_disease.to_s }
  let(:comorbidity_asthma)                              { other_patient.comorbidity_asthma.to_s }
  let(:comorbidity_chronic_kidney_disease)              { other_patient.comorbidity_chronic_kidney_disease.to_s }
  let(:comorbidity_liver_disease)                       { other_patient.comorbidity_liver_disease.to_s }
  let(:comorbidity_mild_liver_disease)                  { other_patient.comorbidity_mild_liver_disease.to_s }
  let(:comorbidity_chronic_neurological_disorder)       { other_patient.comorbidity_chronic_neurological_disorder.to_s }
  let(:comorbidity_malignant_neoplasia)                 { other_patient.comorbidity_malignant_neoplasia.to_s }
  let(:comorbidity_chronic_hemathological_disease)      { other_patient.comorbidity_chronic_hemathological_disease.to_s }
  let(:comorbidity_hiv)                                 { other_patient.comorbidity_hiv.to_s }
  let(:comorbidity_obesity)                             { other_patient.comorbidity_obesity.to_s }
  let(:comorbidity_diabetes_with_complications)         { other_patient.comorbidity_diabetes_with_complications.to_s }
  let(:comorbidity_diabetes)                            { other_patient.comorbidity_diabetes.to_s }
  let(:comorbidity_rheumatologic_disease)               { other_patient.comorbidity_rheumatologic_disease.to_s }
  let(:comorbidity_dementia)                            { other_patient.comorbidity_dementia.to_s }
  let(:comorbidity_malnutrition)                        { other_patient.comorbidity_malnutrition.to_s }
  let(:comorbidity_smoking)                             { other_patient.comorbidity_smoking.to_s }
  let(:comorbidity_other)                               { other_patient.comorbidity_other.to_s }
  let(:comorbidity_other_comment)                       { other_patient.comorbidity_other_comment.to_s }
